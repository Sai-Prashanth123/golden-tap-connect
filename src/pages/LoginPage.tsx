              ...
              >
                ...
                <div className="mt-6 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-muted-foreground">or sign in / sign up instantly</span>
                    <div className="flex-1 h-px bg-border" />
                  </div>
                  <Button
                    type="button"
                    ...
                    onClick={() => handleGoogleLogin('attendee')}
                    disabled={loading}
                  >
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    New? You'll be signed up automatically as an Attendee.{' '}
                    <Link to="/register" className="text-primary hover:underline">Sign up as Organizer</Link>
                  </p>
                </div>
              </motion.div>
            ) : (
